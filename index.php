...
<section class="full-reset font-cover" style="background-image: url(assets/img/fondo1.jpg);">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-sm-push-6">
					...
					<p class="lead">El local cuenta con aulas amplias para la comodidad de sus estudiantes
					...
					<div id="slider-ins" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner" role="listbox">
					    ...
					    <div class="item active">
					      <img src="assets/gallery/fond1.jpg" alt="Default">
						...
						<!-- Segunda imagen -->
					    <div class="item">
					      <img src="assets/gallery/fond2.jpg" alt="Default">
					      <div class="carousel-caption">
					        Lorem ipsum dolor sit amet
					      </div>
					    </div>
						...
						<!-- Tercera imagen -->
					    <div class="item">
					      <img src="assets/gallery/fond3.jpg" alt="Default">
					      <div class="carousel-caption">
					        Lorem ipsum dolor sit amet
					      </div>
					    </div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6">
					<video controls>
						<source src="assets/video/pronombres.mp4" type="video/mp4">
					</video>
				</div>
			</div>
		</div>
	...
	<section class="events-ins">
		<div class="container-fluid">
			<h2 class="text-center titles">SERVICIOS DE LA INSTITUCION</h2>
			<br><br>
			<div class="row">
				<!--======================================== Articulo 1 ========================================-->
				<article class="col-xs-12 col-sm-6 col-md-4">
					<div class="thumbnail">
				      <img src="assets/gallery/imagen1.jpg" alt="IMG" class="img-responsive img-rounded">
				      <div class="caption">
				        <h3 class="text-center">INGLÉS</h3>
				        <p class="text-justify"> El inglés es el idioma más hablado del mundo y la lengua oficial de 53 países. Se necesita para una infinidad de cosas, como trabajar, estudiar o viajar.</p>
