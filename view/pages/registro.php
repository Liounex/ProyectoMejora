...
?>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    Usuarios con cuenta 
                    <a href="./index.php" class="text-primary text-gradient font-weight-bold">Ingrese aqui</a>&nbsp;&nbsp;&nbsp;
                    <a href="./tramite.php" class="text-primary text-gradient font-weight-bold">Continuar</a>
                  </p>
                </div>
<?php
