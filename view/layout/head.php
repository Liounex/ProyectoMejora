...
<body>
	...
	<!--======================================== INCLUDE DE HEADER ========================================-->
    <header class="full-reset header" style="background-image:url(./assets/img/fondo.jpg);">
		<!--======================================== Logo(Nombre INS) ========================================-->
		...
		<nav class="full-reset navigation">
			<ul class="full-reset list-unstyled">
				...
				<li><a href="./view/institucion">INSTITUCION</a></li>
				<li><a href="./view/secretaria">SECRETARIA</a></li>
				<li><a href="./view/servicios">SERVICIOS</a></li>
				<li><a href="./view/galeria">GALERIA</a></li>
				<li><a href="#" class="btm-mega-menu"><i class="fa fa-caret-down"></i></a></li>
			</ul>
		</nav>
		<!--======================================== Mega menu ========================================-->
		<div class="full-reset mega-menu" style="background-image:url(./assets/img/fondo.jpg);">
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-3">
						...
						<ul class="list-unstyled full-reset">
							...
							<li><a href="./view/pages/index" class=""><i class="fa fa-graduation-cap"></i>&nbsp; Inicia Sessión</a></li>
							<li><a href="https://indi.unsch.edu.pe/index/reglamento" class="open-link-newTab"><i class="fa fa-file-text-o"></i>&nbsp; Matriculate</a></li>
							<li><a href="./view/pages/registro" target=""><i class="fa fa-star-o"></i>&nbsp; Inicia Trámite</a></li>
							<li><a href="./view/content/pago" target=""><i class="fa fa-gavel"></i>&nbsp; Realizar pagos</a></li>				
						</ul>
					</div>
				</div>
			</div>
