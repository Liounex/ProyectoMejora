    ...
    <header class="full-reset header" style="background-image:url(/proyectomejora/assets/img/fondo.jpg);">
		...
		<nav class="full-reset navigation">
			<ul class="full-reset list-unstyled">
				<li><a href="/proyectomejora/index">INICIO</a></li>
				<li><a href="/proyectomejora/view/institucion">INSTITUCION</a></li>
				<li><a href="/proyectomejora/view/secretaria">SECRETARIA</a></li>
				<li><a href="/proyectomejora/view/servicios">SERVICIOS</a></li>
				<li><a href="/proyectomejora/view/galeria">GALERIA</a></li>
				<li><a href="#" class="btm-mega-menu"><i class="fa fa-caret-down"></i></a></li>
			</ul>
		</nav>
		<!--======================================== Mega menu ========================================-->
		<div class="full-reset mega-menu" style="background-image:url(/proyectomejora/assets/img/fondo.jpg);">
			<div class="container">
				<div class="row">
