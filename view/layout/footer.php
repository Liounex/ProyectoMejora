<footer class="full-reset footer" style="background-image:url(<?= APP_URL . '/assets/img/fondo.jpg ' ?>);">
	<div class="full-reset" style="padding: 15px 0;">
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12">
					<div class="full-reset footer-copyright"><i class="fa fa-copyright"></i> 2023 Indi Unsch</div>
				</div>
			</div>
		</div>
	</div>
