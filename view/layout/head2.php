				...
				<div class="row">
					<div class="col-xs-12 col-sm-3">
						...
						<ul class="list-unstyled full-reset">
							...
							<li><a href="./pages/index" class=""><i class="fa fa-graduation-cap"></i>&nbsp; Inicia Sessión</a></li>
							<li><a href="https://indi.unsch.edu.pe/index/reglamento" class="open-link-newTab"><i class="fa fa-file-text-o"></i>&nbsp; Matriculate</a></li>
							<li><a href="./pages/registro" target=""><i class="fa fa-star-o"></i>&nbsp; Inicia Trámite</a></li>
							<li><a href="./content/pago" target=""><i class="fa fa-gavel"></i>&nbsp; Realizar pagos</a></li>		
						</ul>
					</div>
				</div>
			</div>
